/**
* RelationshipContributionACL extension admin screen logic. All HTML elements are created by this 
...
cj(function ($) {
  ...
  */
  function createGUI() {
    var container = $('#relationshipContributionACLAdminContainer');
  ...
  */
  function createAddButton() {
    var html = '<div id="relationshipContributionACLAdmin_addButtonContainer">';
  ...
  */
  function createEditForm() {
    var html = '<div id="relationshipContributionACLAdmin_editFormContainer" class="crm-block crm-form-block" style="display: none;">';
    html += '<form>';
    ...
    html += '<td id="config_key">contributionOwnerCustomFieldId</td>';
    html += '</tr>';
  ...
  */
  function createConfigTableContainer() {
    var html = '<div id="relationshipContributionACLAdmin_configTableContainer">';
  ...
  */
  function reloadConfigAjax(callback) {
    $.ajax({
      dataType: "json",
      url: CRM.relationshipContributionACL.getConfigAjaxURL,
      success: callback 
    });
  }
  ...
  */
  function updateConfigTable() {
    reloadConfigAjax(function(result) {
      configRows = result;
      $('#relationshipContributionACLAdmin_configTableContainer').html(createConfigTable());
      initTableEditLinkListeners();
    });
  }
  ...
  */
  function configDeleteLinkClicked(eventObject) {
    ...
    $.ajax({
      url: CRM.relationshipContributionACL.deleteConfigRowAjaxURL,
      data: data,
      success: function() {
        updateConfigTable();
      }
  ...
  */
  function showEditForm() {
    $('#addNewButton').hide();
    $('#relationshipContributionACLAdmin_editFormContainer').show();
  ...
  */
  function hideEditForm() {
    $('#addNewButton').show();
    $('#relationshipContributionACLAdmin_editFormContainer').hide();
  }
  ...
  */
  function saveConfigForm() {
    ...
    $.ajax({
      url: CRM.relationshipContributionACL.saveConfigRowAjaxURL,
      data: getFormData(),
  ...
  */
  function showServerErrorMessage(message) {
    $('#relationshipContributionACLAdmin_editFormContainer .crm-submit-buttons').append('<label class="crm-inline-error">' + message + '</label>');
  }
  ...
  */
  function clearServerErrorMessage() {
    $('#relationshipContributionACLAdmin_editFormContainer .crm-submit-buttons .crm-inline-error').remove();
  }
